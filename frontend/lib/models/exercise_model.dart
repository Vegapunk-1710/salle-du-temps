  ...
  static List<Exercise> examples() {
    return [
      Exercise(
        ...
        time: 10,
        type: 'Strength',
        progression: [('2023-01-01', 0), ('2023-02-01', 5)],
        tutorial: 'Step 1: Get into a high plank position. Step 2: Lower your body keeping back straight. Step 3: Push back up.'
      ),
      Exercise(
        id: 'ex2',
        title: 'Running',
